...
from datk.root.roofit import dst_iter
...
set_attribute(ROOT.RooAbsData, '__iter__', dst_iter)

# container length
set_attribute(ROOT.RooAbsCollection, '__len__', 'getSize')
set_attribute(ROOT.RooLinkedList, '__len__', 'GetSize')
